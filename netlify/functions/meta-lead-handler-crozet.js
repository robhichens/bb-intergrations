...
//
// Receives a Crozet lead (from Zapier's Facebook Lead Ads trigger,
...
// Crozet location_id from GET /api/v2/lead/config.
// NOTE: FL, Mill Creek, and Crozet IDs are distinct — this is Crozet.
const CROZET_LOCATION_ID = "1095544634151518630";
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === "GET") {
    return json(200, {
      status: "alive",
      message: "Crozet lead handler is live. POST a lead here to forward it to IKS.",
      location_id: CROZET_LOCATION_ID,
  ...
  const payload = {
    ...
    utm_campaign: "CR_Nature_2026-06",
  };
