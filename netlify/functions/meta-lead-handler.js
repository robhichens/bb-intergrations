...
//
// Receives a Forest Lakes lead (from Zapier's Facebook Lead Ads trigger,
...
// Forest Lakes location_id from GET /api/v2/lead/config.
// NOTE: FL and Mill Creek IDs are nearly identical — this is FL.
const FOREST_LAKES_LOCATION_ID = "1095544633769838116";
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === "GET") {
    return json(200, {
      status: "alive",
      message: "Forest Lakes lead handler is live. POST a lead here to forward it to IKS.",
      location_id: FOREST_LAKES_LOCATION_ID,
  ...
  const payload = {
    ...
    utm_campaign: "FL_Nature_2026-06",
  };
